    ...
    <div className="text-center mb-8">
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-center gap-4 mb-6">
          {/* YouTube */}
          <a 
            href="https://www.youtube.com/@aleksa-ai" 
            target="_blank" 
            rel="noopener noreferrer"
            className="w-10 h-10 bg-white/30 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/50 transition-colors cursor-pointer border border-white/20"
          >
          ...
          {/* LinkedIn */}
          <a 
            href="https://www.linkedin.com/in/aleksaspalevic/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="w-10 h-10 bg-white/30 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/50 transition-colors cursor-pointer border border-white/20"
          >
          ...
          {/* Instagram */}
          <a 
            href="https://www.instagram.com/iamaleksa.ai/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="w-10 h-10 bg-white/30 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/50 transition-colors cursor-pointer border border-white/20"
          >
